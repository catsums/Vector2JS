...
var Vector2_exports = {};
__export(Vector2_exports, {
  Vector2: () => Vector2
});
module.exports = __toCommonJS(Vector2_exports);
...
class Vector2 {
  ...
  static MOD(v1, v2) {
    return new Vector2(
      (0, import_MY.mod)(v1.x, v2.x),
      (0, import_MY.mod)(v1.y, v2.y)
    );
  }
  mod(other) {
    this.x = (0, import_MY.mod)(this.x, other.x);
    this.y = (0, import_MY.mod)(this.y, other.y);
  }
  static MODBY(v1, n) {
    return new Vector2(
      (0, import_MY.mod)(v1.x, n),
      (0, import_MY.mod)(v1.y, n)
    );
  }
  modBy(n) {
    this.x = (0, import_MY.mod)(this.x, n);
    this.y = (0, import_MY.mod)(this.y, n);
  }
  static DOT(v1, v2) {
  ...
  static EQUALS(v1, v2, precision = 0) {
    ...
    if (v1?.x === v2?.x && v1?.y === v2?.y)
      return true;
    if ((0, import_MY.roundTo)(v1.x, p) === (0, import_MY.roundTo)(v2.x, p) && (0, import_MY.roundTo)(v1.y, p) === (0, import_MY.roundTo)(v2.y, p))
      return true;
  ...
  ratioed() {
    ...
    return new Vector2(
      (0, import_MY.safeDivide)(this.x, sum),
      (0, import_MY.safeDivide)(this.y, sum)
    );
  }
  isNormalised() {
  ...
  normalized() {
    ...
    return new Vector2(
      (0, import_MY.safeDivide)(this.x, llen),
      (0, import_MY.safeDivide)(this.y, llen)
    );
  }
  normalised() {
  ...
  gradient() {
    return (0, import_MY.safeDivide)(this.y, this.x);
  }
  angle() {
  ...
  static INVERSE(v1) {
    let ix = (0, import_MY.safeDivide)(1, v1.x);
    let iy = (0, import_MY.safeDivide)(1, v1.y);
    return new Vector2(ix, iy);
  }
  inverse() {
    let ix = (0, import_MY.safeDivide)(1, this.x);
    let iy = (0, import_MY.safeDivide)(1, this.y);
    return new Vector2(ix, iy);
  }
  static FLIPPED(v1) {
  ...
  static MIDPOINT(arr) {
    ...
    let x = (0, import_MY.safeDivide)(_x, arr.length);
    let y = (0, import_MY.safeDivide)(_y, arr.length);
    return new Vector2(x, y);
  }
  midPoint(other) {
    let arr = [];
    ...
    _x += this.x;
    _y += this.y;
    let x = (0, import_MY.safeDivide)(_x, arr.length + 1);
    let y = (0, import_MY.safeDivide)(_y, arr.length + 1);
    return new Vector2(x, y);
  }
  floor() {
